...
const caseStudies = [
  ...
  },
  {
    ...
    challenge: 'Intrinsic develops AI driven training acceleration tools, aircraft simulation environments, and cloud deployment platforms such as SkyHub. These systems operate in technically dense, high stakes environments serving highly specialized users. The challenge extended beyond interface clarity. It required reducing risk across multiple enterprise dimensions: data dense operator environments, AI trust and explainability gaps, time compressed decision cycles, fragmented cross functional messaging, and sales conversations stalled by technical complexity. Without embedded UX, enterprise AI products face measurable cost including longer onboarding cycles, increased training burden, late stage engineering rework, reduced operator adoption, extended sales timelines, and fragmented brand credibility. The objective was to transform technically advanced systems into operationally trustworthy and narratively coherent platforms.',
    process: 'I embedded UX across product, research, marketing, and executive communication layers. For adoption and friction analysis, I conducted qualitative interviews with operators, SMEs, and internal stakeholders, mapping user mental models against product capabilities to identify adoption friction and workflow misalignment. In translation layer design, I transformed complex AI functionality into mission grounded narratives, structured demos around real operational scenarios, and designed product cards, training collateral, and messaging frameworks aligned to user workflows. For enterprise alignment, I standardized communication across engineering, sales, marketing, and leadership, applying BLUF style structuring to materials intended for high stakes audiences. I contributed across APEX and Veridian programs to ensure explainability, clarity, and workflow alignment were embedded prior to deployment readiness. To evaluate UX impact at the enterprise level, a value matrix addressed five cost centers: (1) Adoption Cost, where workflow aligned demos and training reduced cognitive friction, preserving operational labor cost and accelerating adoption velocity. (2) Engineering Rework, where research surfaced friction early and informed prioritization models, reducing iteration waste and preserving engineering capacity. (3) Sales Cycle Efficiency, where operational storytelling accelerated proposal readiness and demo effectiveness, improving contract positioning and reducing explanatory friction in buyer conversations. (4) Operational Risk, where explainability guidance, safeguard design, and workflow visibility increased trust, lowering likelihood of operational error and raising AI utilization rates. (5) Brand Credibility, where unified narrative across product, marketing, and leadership channels strengthened positioning within defense and AI ecosystems.',
    outcome: 'Improved clarity and consistency of messaging across APEX and Veridian programs. Enabled sales, leadership, and training teams with reusable, workflow grounded materials. Embedded research insights directly into SBIR cycles, engineering prioritization, and deployment readiness. Reduced adoption friction through explainability and structured demo design. Organically expanded digital presence to over 8,000 LinkedIn followers in one year, increasing brand visibility in defense and AI communities. Most importantly, UX elevated Intrinsic\'s systems from technically impressive solutions to operationally credible platforms trusted by operators and decision makers.',
